...
import 'package:flutter_template/features/user/presentation/components/subscribe_dialog.dart';
                      ...
                      Row(
                        children: [
                          Icon(
                            ...
                            size: 14,
                            color: theme.onSurface.withAlpha(128),
                          ),
        ...
        child: Column(
          ...
          children: [
            Icon(
              ...
              size: 64,
              color: theme.error.withAlpha(128),
            ),
            Gap(AppConstant.verticalGap16),
            Padding(
              padding: EdgeInsets.symmetric(
