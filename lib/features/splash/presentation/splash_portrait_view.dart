...
class SplashPortraitView extends ConsumerStatefulWidget {
  const SplashPortraitView({super.key});

  @override
  ConsumerState<SplashPortraitView> createState() => _SplashPortraitViewState();
}

class _SplashPortraitViewState extends ConsumerState<SplashPortraitView>
